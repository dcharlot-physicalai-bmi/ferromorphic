...
**Zero dependencies. `std` only. `wasm32` clean. Deterministic by seed. 83 modules, 2,811 tests.**
...
2,811 unit tests and nineteen doctests, `cargo clippy --all-targets -- -D warnings` clean,
...
**Today:** eighty-three modules, 2,811 tests, and **8,946 recorded mutations — one list per
