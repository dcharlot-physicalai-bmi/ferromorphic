...
mod tests {
    ...
    /// `(a, b, ISI-distance, SPIKE-distance)` from `PySpike` 0.9.0 over `[0, 1]`.
    const PYSPIKE: [(&[f64], &[f64], f64, f64); 20] = [
        (&[0.0, 0.092797, 0.48907, 0.561901, 0.77776, 0.787116, 1.0], &[0.0, 0.212292, 0.284852, 0.547106, 0.850563, 0.902787, 0.935738, 0.943011, 1.0], 0.4955523385042183, 0.2935362985759883),
        (&[0.0, 0.04472, 0.725417, 0.790468, 1.0], &[0.0, 0.385591, 0.617572, 0.619392, 0.816469, 1.0], 0.48527766833338853, 0.25378984949560546),
        (&[0.0, 0.098633, 0.218874, 0.325949, 0.59645, 0.86898, 0.923088, 0.933458, 1.0], &[0.0, 0.060591, 0.095252, 0.548922, 0.637444, 0.866367, 0.89912, 0.996092, 1.0], 0.46236221588275805, 0.23302662797358104),
        (&[0.0, 0.620041, 0.995126, 1.0], &[0.0, 0.0299, 0.112866, 0.240148, 0.383711, 0.485433, 0.921237, 0.977963, 1.0], 0.546891993781344, 0.30467866848427727),
        (&[0.0, 0.151689, 0.167248, 0.235662, 0.277218, 0.535159, 0.610799, 0.612646, 0.701401, 0.733286, 0.839778, 0.875902, 0.920496, 1.0], &[0.0, 0.065362, 0.187688, 1.0], 0.7569427167490831, 0.35648295208856656),
        (&[0.0, 0.123279, 0.394202, 0.394721, 0.439634, 0.669976, 0.725987, 0.745578, 0.80034, 0.944923, 1.0], &[0.0, 0.021785, 0.152159, 0.426499, 0.572751, 0.709208, 0.775866, 1.0], 0.3222754155146015, 0.19216979785516633),
        (&[0.0, 0.025534, 0.597924, 0.652, 0.863039, 0.928465, 1.0], &[0.0, 0.397318, 1.0], 0.45542216246828815, 0.28158388524925443),
        (&[0.0, 0.059933, 0.120505, 1.0], &[0.0, 0.04434, 0.074488, 0.247593, 0.480677, 0.790557, 0.965708, 1.0], 0.703819198264376, 0.2791302965701926),
        (&[0.0, 0.579624, 0.677664, 0.727747, 0.818386, 1.0], &[0.0, 0.057901, 0.324345, 0.468025, 0.502101, 0.633184, 0.6584, 0.738141, 0.836167, 0.986426, 0.998197, 1.0], 0.5048784979746422, 0.23972757786621027),
        (&[0.0, 0.148824, 0.220629, 0.249119, 0.352517, 0.365038, 0.433246, 0.548295, 0.554093, 0.676309, 0.882028, 0.88905, 0.974093, 1.0], &[0.0, 0.080948, 1.0], 0.8362288625536765, 0.38711956566996153),
        (&[0.0, 0.652823, 0.7692, 0.881733, 1.0], &[0.0, 0.698785, 0.779909, 1.0], 0.21004223475197217, 0.09676777917667327),
        (&[0.0, 0.078503, 0.84795, 1.0], &[0.0, 0.185414, 0.502149, 0.872961, 1.0], 0.5275730198162133, 0.24182635947961584),
        (&[0.0, 0.267847, 0.789008, 0.933521, 0.960719, 1.0], &[0.0, 0.138454, 0.291875, 0.293374, 0.294074, 0.425115, 0.461098, 0.641562, 0.676109, 0.692659, 0.792285, 0.95645, 0.96518, 1.0], 0.5644658493044552, 0.23976817081696428),
        (&[0.0, 0.052474, 0.188431, 0.281093, 0.429401, 0.624117, 0.748413, 0.823716, 0.867837, 0.909324, 1.0], &[0.0, 0.500212, 0.557491, 0.632191, 1.0], 0.7345596328226824, 0.3468944214946835),
        (&[0.0, 0.389423, 1.0], &[0.0, 0.085134, 0.658541, 1.0], 0.3310414384221322, 0.29082012497984827),
        (&[0.0, 0.00708, 0.152753, 0.303237, 0.452518, 0.752475, 0.962845, 1.0], &[0.0, 0.276771, 0.353168, 0.521761, 0.623613, 1.0], 0.43131222480069187, 0.2931912247149923),
        (&[0.0, 0.184515, 0.30132, 0.407305, 0.407561, 0.412318, 0.444964, 0.555779, 0.919121, 1.0], &[0.0, 0.408773, 0.417223, 1.0], 0.5921952279184128, 0.19560780188613305),
        (&[0.0, 0.00689, 0.147619, 0.192729, 0.260365, 0.374427, 0.459858, 0.544348, 0.819099, 0.971979, 1.0], &[0.0, 0.064763, 0.106495, 0.270392, 0.443493, 0.614125, 0.963371, 1.0], 0.4337349553477134, 0.2800433879198755),
        (&[0.0, 0.499303, 0.589331, 1.0], &[0.0, 0.052202, 0.295568, 0.437493, 0.590252, 0.722492, 0.783762, 0.822506, 0.888569, 0.895675, 1.0], 0.6706386577524998, 0.29153851921440255),
        (&[0.0, 0.023061, 0.126577, 0.197021, 0.211249, 0.255037, 0.320336, 0.408539, 0.536516, 0.726658, 0.814885, 0.823538, 0.881455, 1.0], &[0.0, 0.090435, 0.37722, 0.473092, 0.532079, 0.715736, 0.837194, 0.886741, 1.0], 0.358119591083873, 0.22354673474159747),
    ];

    /// The ISI- and SPIKE-distances are `PySpike`'s, on twenty random pairs of trains that both
    /// bracket the window — the case this module and `PySpike` define identically. Measured: within
    /// 2.2 × 10⁻¹⁶. `tools/pyspike_reference.py distance` regenerates the table.
    #[test]
    fn the_kreuz_distances_are_pyspikes() {
        for (a, b, isi, spike) in PYSPIKE {
            let (i, s) = (isi_distance(a, b, 0.0, 1.0).unwrap(), spike_distance(a, b, 0.0, 1.0).unwrap());
            assert!((i - isi).abs() <= 1e-15 && (s - spike).abs() <= 1e-15, "{a:?} {b:?}: ({i}, {s}) against ({isi}, {spike})");
        }
    }
}
